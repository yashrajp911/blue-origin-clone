...
try{
    ...
    PreparedStatement ps = conn.prepareStatement("insert into register(firstname,lastname,email,phonenumber,address_one,address_two,city,state,zipcode,country,date_of_birth,when_to_fly,number_of_seats) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
